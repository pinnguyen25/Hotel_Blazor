...
public class PriceCalculationVM
{
    public int HotelId { get; set; }
    public int UserId { get; set; }
    public List<BookingRoomDetailRequestVM> SelectedRooms { get; set; } = new();
    public List<ServiceAddOnVM> SelectedServices { get; set; } = new();
...
public class RoomSelection { public int RoomTypeId; public int Quantity; }
public class ServiceRequest { public int ServiceId; public int Quantity; }

// 2. Kết quả tính giá trả về
public class PriceResultVM
{
