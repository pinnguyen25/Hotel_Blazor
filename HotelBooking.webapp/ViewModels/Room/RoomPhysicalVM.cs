public class RoomPhysicalVM
{
    ...
    public int? CurrentBookingRoomId { get; set; }
    ...
    public string RoomNumberFull => $"{RoomNumber} - {RoomTypeName}";
}

public class CreateRoomRequestVM
{
    public string? RoomNumber { get; set; }
}

public class UpdateRoomPhysicalVM
{
    public string? RoomNumber { get; set; }
    public string? Status { get; set; } // Nếu Owner chuyển sang Maintenance, hệ thống phải chặn booking
}
// Thêm hành động Gán phòng
public class AssignRoomRequestVM
{
...
public class UpdateGuestNameVM
{
